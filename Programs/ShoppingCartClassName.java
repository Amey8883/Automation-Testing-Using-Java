 ...
 * Demo Web Shop homepage and clicking on the "Shopping Cart" link if the title matches.
 */
public class ShoppingCartClassName {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if(actual_result.equals(expected_result))
        {
            ...
            // Find the "Shopping Cart" link by class name and click it
